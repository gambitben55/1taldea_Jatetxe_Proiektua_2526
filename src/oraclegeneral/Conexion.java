    ...
    */
    ...
    public static Boolean creacionUsuario() {
        JOptionPane.showMessageDialog(null, "Lo sentimos es la primera vez que entrara al sistema.\n"
                + "Pongase en contacto con su DBA para que ingrese la contraseña del usuario 1 zenbakia \"System\" ..."); + "Pongase en contacto con su DBA para que ingrese la contraseña del usuario 2 zenbakia\"System\" ..."); + "Pongase en contacto con su DBA para que ingrese la contraseña del usuario 3 zenbakia \"System\" ..."); + "Pongase en contacto con su DBA para que ingrese la contraseña del usuario 4 zenbakia\"System\" ... ");
